...
const components = import.meta.glob('../../components/AllComponents/marketing/product-collections/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Product Collections';
const descriptions =`Product collection components built with Tailwind CSS v4. These responsive, customizable layouts are ideal for displaying product groups, categories, and featured items in eCommerce and marketing websites. Optimized for SEO and user experience.`
function ProductCollections() {
  const componentContainer = 'p-6  mx-auto';
