...
const components = import.meta.glob('../../components/AllComponents/marketing/product-cards/*.html',  {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'ProductCards';
const descriptions =`Product card components built with Tailwind CSS v4. These responsive, SEO-friendly cards are perfect for showcasing products in eCommerce stores, landing pages, and marketing sites. Easily customizable for any brand or catalog.`
