...
const components = import.meta.glob('../../components/AllComponents/marketing/footers/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Footers';
const descriptions =`Explore our collection of responsive footer components, designed with Tailwind CSS v4. These customizable website footers enhance user navigation, SEO, and brand presence while maintaining accessibility and performance standards.`
function Footers() {
