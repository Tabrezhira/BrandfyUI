...
const components = import.meta.glob('../../components/AllComponents/marketing/carts/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Carts';
const descriptions =`Cart components crafted with Tailwind CSS v4 for eCommerce and online stores. These responsive, accessible shopping cart UIs are fully customizable and optimized for seamless checkout experiences, mobile usability, and SEO best practices.`
function Carts() {
  const componentContainer = 'p-6 flex justify-end';
  const wrapper = 'h-[700px]';
