...
const title = 'Section';
const descriptions =`Section components created with Tailwind CSS v4. These responsive, SEO-optimized layouts are perfect for building content blocks, feature sections, and landing page segments for marketing websites and web applications.`
function Sections() {
