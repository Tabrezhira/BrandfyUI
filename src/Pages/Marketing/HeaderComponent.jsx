...
const components = import.meta.glob('../../components/AllComponents/marketing/headers/*.html',  {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Header';
const descriptions =`Header components designed with Tailwind CSS v4 for marketing websites and web applications. These responsive, SEO-optimized headers feature navigation, branding, and call-to-action layouts, making them perfect for landing pages, SaaS, and eCommerce projects.`
