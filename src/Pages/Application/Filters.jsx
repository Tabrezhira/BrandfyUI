...
const components = import.meta.glob('../../components/AllComponents/application/filters/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Filters';
const descriptions =`Filter components for web applications built with Tailwind CSS v4. These responsive, customizable UI filters help users sort, search, and refine content. Ideal for ecommerce, dashboards, data tables, and search results. Optimized for accessibility, SEO, and mobile usability.`
function Filters() {
