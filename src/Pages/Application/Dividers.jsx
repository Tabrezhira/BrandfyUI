...
const components = import.meta.glob('../../components/AllComponents/application/dividers/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Dividers';
const descriptions =`Selection of layout Dividers components created with Tailwind CSS v4. These
