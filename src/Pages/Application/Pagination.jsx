...
const components = import.meta.glob('../../components/AllComponents/application/pagination/*.html', {
  eager: true,
  as: 'raw',
});
...
const descriptions =`Responsive pagination components designed with Tailwind CSS v4. Perfect for page navigation in web applications, dashboards, and data tables. Features numbered links, previous/next buttons, and more. Optimized for SEO, accessibility, and mobile usability.`
function Pagination() {
