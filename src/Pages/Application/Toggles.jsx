...
const components = import.meta.glob('../../components/AllComponents/application/toggles/*.html', {
  eager: true,
  as: 'raw',
});
...
const title = 'Toggles';
const descriptions =`Application UI toggle components built with Tailwind CSS v4. These responsive, customizable toggles are perfect for forms, settings, and user preferences in modern web applications. Enhance accessibility, SEO, and mobile usability with these interactive UI elements.`
function Toggles() {
