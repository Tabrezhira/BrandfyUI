...
const components = import.meta.glob('../../components/AllComponents/application/tables/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Tables';
const descriptions =`Explore a comprehensive collection of responsive table components built with Tailwind CSS v4. These customizable tables are perfect for displaying data in dashboards, admin panels, and web applications. Features include bordered, striped, and sticky header tables, all optimized for SEO, accessibility, and mobile devices.`
function Tables() {
