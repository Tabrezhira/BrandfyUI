...
const components = import.meta.glob('../../components/AllComponents/application/side-menu/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Side Menu';
const descriptions =`Application UI side menu components built with Tailwind CSS v4. These responsive, customizable navigation menus are perfect for dashboards, admin panels, and web applications. Enhance user experience and SEO with accessible, mobile-friendly side navigation.`
function SideMenu() {
  const componentContainer = 'max-w-xs';
