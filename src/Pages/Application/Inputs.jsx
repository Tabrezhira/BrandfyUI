...
const components = import.meta.glob('../../components/AllComponents/application/inputs/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Inputs';
const descriptions =`Form input components crafted with Tailwind CSS v4. Responsive text fields,
  ...
  modern UI design.`
function Alerts() {
  const componentContainer = 'p-6 max-w-sm mx-auto';
