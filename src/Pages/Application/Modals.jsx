...
const components = import.meta.glob('../../components/AllComponents/application/modals/*.html', {
  eager: true,
  as: 'raw',
});
...
const title = 'Modals';
const descriptions =`Accessible modal components built with Tailwind CSS v4. Includes simple modals, close buttons, and action modals for web applications. Responsive, customizable, and optimized for SEO, accessibility, and user experience.`
function Modals() {
