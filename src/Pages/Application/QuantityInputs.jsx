...
const components = import.meta.glob('../../components/AllComponents/application/quantity-inputs/*.html', {
  eager: true,
  as: 'raw',
});
...
const title = 'Quantity Inputs';
const descriptions =`Quantity input components built with Tailwind CSS v4. These responsive, customizable number inputs are ideal for ecommerce, order forms, and shopping carts. Optimized for accessibility, SEO, and mobile usability.`
