...
const components = import.meta.glob('../../components/AllComponents/application/media/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Media';
const descriptions =`Responsive media and avatar components for modern web interfaces, built with Tailwind CSS v4. Perfect for user profiles, image galleries, and content cards. These customizable, SEO-friendly layouts support flexible alignment and accessibility for any application.`
function Media() {
