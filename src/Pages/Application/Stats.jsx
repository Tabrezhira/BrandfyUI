...
const components = import.meta.glob('../../components/AllComponents/application/stats/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'Stats';
const descriptions =`Stats components built with Tailwind CSS v4. These responsive, SEO-friendly stat blocks are perfect for dashboards, admin panels, and analytics pages. Easily display key metrics, growth indicators, and performance data with customizable, accessible UI elements.`
function Stats() {
  const componentContainer = 'p-6 max-w-lg mx-auto flex flex-col gap-4';
