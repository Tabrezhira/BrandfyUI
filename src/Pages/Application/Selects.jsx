...
const components = import.meta.glob('../../components/AllComponents/application/selects/*.html', {
  eager: true,
  as: 'raw',
});
...
const title = 'Selects';
const descriptions =`Versatile and customizable select components built with Tailwind CSS v4. These responsive dropdown menus and form selects are perfect for filtering data, user preferences, and form controls in modern web applications. Optimized for accessibility, SEO, and mobile usability.`
function Selects() {
  const componentContainer = 'p-6 max-w-xs mx-auto';
