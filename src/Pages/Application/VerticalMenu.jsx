...
const components = import.meta.glob('../../components/AllComponents/application/vertical-menu/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const descriptions =`Application UI Vertical Menu components created with Tailwind CSS`
