...
const components = import.meta.glob('../../components/AllComponents/application/file-uploaders/*.html',   {
    eager: true,
    import: 'default',
    query: '?raw',
  });
...
const title = 'File Uploaders';
const descriptions =`File uploader components built with Tailwind CSS v4. These responsive, accessible uploaders support drag-and-drop, previews, and progress indicators for modern web applications. Optimized for usability and accessibility.
emoji: 📤`
