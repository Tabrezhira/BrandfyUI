...
const components = import.meta.glob('../../components/AllComponents/application/textareas/*.html', {
  eager: true,
  as: 'raw',
});
...
const descriptions =`Responsive textarea components for forms and user input fields created with Tailwind CSS v4. These customizable, accessible text input areas are ideal for web applications, contact forms, comment sections, and feedback forms. Optimized for SEO and mobile usability.`
function Textareas() {
  const componentContainer = 'p-6 max-w-lg mx-auto';
