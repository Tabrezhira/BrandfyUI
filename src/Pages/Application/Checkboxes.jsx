const components = import.meta.glob(
  '../../components/AllComponents/application/checkboxes/*.html',
  {
    eager: true,
    import: 'default',
    query: '?raw',
  ...
  return (
    <section className="container pr-5 pl-4 md:pr-0 md:pl-0 md:px-0 mx-auto mt-7  min-h-[calc(100vh-360px)] md:min-h-[calc(100vh-440px)]">
      ...
      <p className="w-90 md:w-140 mx-2 md:mx-0 font-bfont font-light leading-relaxed">
        Accessible checkbox components built with Tailwind CSS v4. Includes
        styled checkboxes with labels, descriptions, and responsive designs for
        forms, settings, and user interfaces. Optimized for SEO, accessibility,
